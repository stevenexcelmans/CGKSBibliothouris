...
public class BookController {
    ...
    public
    @ResponseBody
    ResponseEntity<List<Book>> searchBook(
            @RequestParam(value = "ISBN") String partialIsbn) {
    ...
    public
    @ResponseBody
    ResponseEntity<List<Book>> searchByPartialTitle(
    ...
    public
    @ResponseBody
    ResponseEntity<List<Book>> searchByPartialAuthor(
            @RequestParam (value = "author") String partialAuthor) {
